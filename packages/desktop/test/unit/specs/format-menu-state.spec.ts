...
describe('menu template accelerators match the platform keybinding tables (Paragraph/Edit/View)', () => {
  ...
  it('binds the checklist-named ids to their documented platform accelerators', () => {
    ...
    expect(referencedIds(editTemplate as unknown as Template)).toContain('edit.undo')
    expect(referencedIds(editTemplate as unknown as Template)).toContain('edit.copy')
    expect(referencedIds(editTemplate as unknown as Template)).not.toContain('edit.duplicate')
    expect(referencedIds(editTemplate as unknown as Template)).not.toContain('edit.find-next')
