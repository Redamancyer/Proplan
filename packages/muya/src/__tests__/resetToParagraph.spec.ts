...
describe('paragraph front menu — block image command', () => {
    it('invokes the existing image formatter from an empty paragraph', () => {
        const muya = bootMuya('\n');
        ...
        menu.selectItem(new Event('click'), { label: 'block-image' });
        muya.flush();
